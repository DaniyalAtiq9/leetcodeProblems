# In this section, I solved LeetCode # 66. Plus One. The
# easiest problem so far. The description reads as:
...
# significant in left-to-right order. The large integer does
...
# For convenience, I have added a main function so you first
# test on your own IDE and then proceed to LeetCode
if __name__ == "__main__":
    ...
    result = plusOne(num)
    print(result)
# The time complexity of this code is O(n) since the loop
# n times and space complexity is 0(1), since no extra space
# is used.